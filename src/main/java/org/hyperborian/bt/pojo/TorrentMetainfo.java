...
public class TorrentMetainfo {
	...
	public static Map<String, ContentType> classes;
	...
	static {
		...
		classes.put("nfo", ContentType.text_plain);
		...
		classes.put("gif", ContentType.image_gif);
		classes.put("png", ContentType.image_png);
		classes.put("tif", ContentType.image_tiff);
		classes.put("tiff", ContentType.image_tiff);
